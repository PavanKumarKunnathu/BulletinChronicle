...
print("sorrted senytences scores",sorted(sentence_scores))
for i in sentence_scores:
    print(sentence_scores[i],i)

#to get 30% of the score is maximizing score

select_length=int(len(sentence_tokens)*0.3)
print("selected length of text summary is: ",select_length)
